...
$projectsToBuild =
    'src\Kingensoft.AspNetCore.SpaServices.TagHelpers'
...
foreach ($project in $projectsToBuild) {
	...
	dotnet msbuild "/t:$targets" "/p:Configuration=Release" "/p:Version=$semVer" "/p:PackageOutputPath=$packageOutputFolder" "/p:SignAssembly=true" "/p:AssemblyOriginatorKeyFile=..\..\build\Key.snk" "/p:CI=true"
